...
const Navbar = () => {
    ...
    useEffect(() => {
        ...
        // Create the active element div and append it to the nav element
        const activeElement = document.createElement("div");
        activeElement.classList.add("active-element");
        navElement.appendChild(activeElement);

        // Utility function to get the offset for a given element
        ...
        // Create the SVG content inside the active element
        ...
        // When fonts are loaded, set the initial position and opacity of the active element
        ...
        buttons.forEach((button, index) => {
            button.addEventListener("click", () => {
                ...
                const oldIndex = Array.from(active.parentElement.children).indexOf(active);

                // Ignore if the clicked button is already active or if an animation is in progress
                if (
                    index === oldIndex ||
                ...
                // Add directional class and update active class on list items
        ...
        return () => {
            buttons.forEach((button) => {
                // Note: Since we used an inline function for the event listener,
                // you might consider using a named handler and removing it here.
                // For simplicity, this example does not remove each listener individually.
